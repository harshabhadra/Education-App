class SubsDetails {
  ...
  SubsDetails(
    ...
    this._status = status;
    this._currentStart = currentStart;
  ...
  set currentStart(int currentStart) => _currentStart = currentStart;
  int get currentEnd => _currentEnd;
  set currentEnd(int currentEnd) => _currentEnd = currentEnd;
  ...
  Map<String, dynamic> toJson() {
    ...
    data['current_start'] = this._currentStart;
    data['current_end'] = this._currentEnd;
